      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "16px", color: "#7f8c8d", fontStyle: "italic", marginTop: "5px" }}>
        ...
        >
          ...
          <p style={{ textAlign: "center", fontSize: "15px", lineHeight: 1.8 }}>
            Sistema contable 100% web diseñado específicamente para oficinas contables en Guatemala. Accede desde
            cualquier dispositivo, en cualquier momento, con la seguridad y flexibilidad que tu negocio necesita.
          </p>
        </div>
        ...
        >
          ...
          >
            ✓ Sin pago inicial de implementación
            <br />
            ✓ Sin costos de instalación
            <br />✓ Facturado mensualmente
          </div>
        </div>
        ...
        >
          <h4 style={{ color: "#d68910", fontSize: "18px", marginBottom: "12px", textAlign: "center" }}>
            ...
            {[
              {
                ...
                desc: "Te ayudamos a importar datos de tu sistema anterior sin costo adicional",
              },
              {
                title: "Capacitación Inicial:",
                desc: "5 horas de capacitación personalizada para tu equipo en el uso del sistema",
              },
              { title: "Soporte Técnico Continuo:", desc: "Corrección de errores y bugs sin costo adicional" },
              {
                title: "Adaptaciones Menores:",
                desc: "Ajustes y mejoras según los procesos de tu oficina incluidos en el plan mensual",
              },
              ...
              <li key={idx} style={{ padding: "8px 0", paddingLeft: "30px", position: "relative", fontSize: "13px" }}>
                <span style={{ position: "absolute", left: 0, color: "#27ae60", fontWeight: "bold", fontSize: "18px" }}>
                  ✓
                </span>
        ...
        <div style={{ marginBottom: "30px" }}>
          ...
          >
            ...
            <div style={{ flex: 1, fontSize: "14px", lineHeight: 1.6 }}>
              Para cambios que requieran creación de nuevas tablas, módulos completos o ventanas adicionales, se
              realizará una cotización por separado según la complejidad del desarrollo solicitado.
            </div>
          </div>
        </div>
        ...
        >
          <p>
            <strong>Conta-Online</strong> - Sistema Contable en la Nube para Guatemala
          </p>
          <p style={{ marginTop: "10px" }}>
            Para más información y solicitar una demostración, contáctanos +502 54135354.
            <br />
          </p>
        </div>
      </div>
