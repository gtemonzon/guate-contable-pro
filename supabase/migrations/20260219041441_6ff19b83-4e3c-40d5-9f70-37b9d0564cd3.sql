...
-- Update v_rls_coverage to include audit_event_log as write-protected
-- (triggers block UPDATE/DELETE, no client INSERT policy exists by design)
...
RETURNS TABLE(tablename text, rls_enabled boolean, policy_count bigint, compliance_gap text)
