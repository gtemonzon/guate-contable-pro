INSERT INTO public.tab_journal_entry_prefixes (code, name, prefix, description, is_active)
VALUES ('TRANSFER', 'Traslado', 'TRAS', 'Partidas de traslado de resultados', true)
...
DECLARE
  ...
  v_type_map jsonb := '{"diario":"MANUAL","apertura":"OPENING","cierre":"CLOSING","traslado":"TRANSFER","ajuste":"ADJUSTMENT","compras":"PURCHASES","ventas":"SALES"}'::jsonb;
BEGIN
